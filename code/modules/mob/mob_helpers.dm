...
/proc/derpspeech(message, stuttering)
	message = _replacetext(message, " am ", " ")
	message = _replacetext(message, " is ", " ")
	message = _replacetext(message, " are ", " ")
	message = _replacetext(message, "you", "u")
	message = _replacetext(message, "help", "halp")
	message = _replacetext(message, "grief", "grife")
	message = _replacetext(message, "space", "spess")
	message = _replacetext(message, "carp", "crap")
	message = _replacetext(message, "reason", "raisin")
	if(prob(50))
