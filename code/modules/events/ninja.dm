...
message = _replacetext(message, "l", "r")
message = _replacetext(message, "rr", "ru")
message = _replacetext(message, "v", "b")
message = _replacetext(message, "f", "hu")
message = _replacetext(message, "'t", "")
message = _replacetext(message, "t ", "to ")
message = _replacetext(message, " I ", " ai ")
message = _replacetext(message, "th", "z")
message = _replacetext(message, "ish", "isu")
message = _replacetext(message, "is", "izu")
message = _replacetext(message, "ziz", "zis")
message = _replacetext(message, "se", "su")
message = _replacetext(message, "br", "bur")
message = _replacetext(message, "ry", "ri")
message = _replacetext(message, "you", "yuu")
message = _replacetext(message, "ck", "cku")
message = _replacetext(message, "eu", "uu")
message = _replacetext(message, "ow", "au")
message = _replacetext(message, "are", "aa")
message = _replacetext(message, "ay", "ayu")
message = _replacetext(message, "ea", "ii")
message = _replacetext(message, "ch", "chi")
message = _replacetext(message, "than", "sen")
message = _replacetext(message, ".", "")
